...
public class RSA8192Public {

    public static final String ALGORITHM = "RSA";

    // private key location in OS
    public static final String PATH_PRIVATE_KEY = "C:/Users/HP/keys/KeyGen/private8192.key";

    // public key location in OS
    public static final String PATH_PUBLIC_KEY = "C:/Users/HP/keys/KeyGen/public8192.key";
    ...
    // encrypts original text using public key

    public static byte[] encrypts(String text, PublicKey key) {
    ...
    // decrypts original text using private key

    public static String decrypts(byte[] text, PrivateKey key) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            final byte[] encryptedText = encrypts(originalText, publicKey);
            inputStream.close();

            // decrypts using private key
            inputStream = new ObjectInputStream(new FileInputStream(PATH_PRIVATE_KEY));
            final PrivateKey privateKey = (PrivateKey) inputStream.readObject();
            final String decryptedText = decrypts(encryptedText, privateKey);
            inputStream.close();

            long finalTime = System.currentTimeMillis();

            System.out.println("Key size: 8192 bits.");
